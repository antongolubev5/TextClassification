...
X, y = data_download_mean_reuters(embeddings_index)
# pd.DataFrame(X).to_csv("reuters.csv")

# загрузка данных, формирование тренировочной и тестовой выборок
# newsgroups_data = np.genfromtxt('reuters.csv', delimiter=',')
...
# nonlinear svm
clf_SVC = OneVsRestClassifier(SVC(kernel='rbf'))
